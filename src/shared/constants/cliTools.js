...
export const MITM_TOOLS = {
  ...
  zed: {
    id: "zed",
    name: "Zed Editor",
    image: "/providers/zed.svg",
    color: "#1348DC",
    description: "Zed Editor (Hosted AI) with MITM",
    configType: "mitm",
    mitmDomain: "cloud.zed.dev",
    defaultModels: [
      { id: "claude-sonnet-5", name: "Claude Sonnet 5", alias: "claude-sonnet-5" },
      ...
      { id: "gpt-5-mini", name: "GPT-5 mini", alias: "gpt-5-mini" },
      { id: "gemini-3.1-pro-preview", name: "Gemini 3.1 Pro", alias: "gemini-3.1-pro-preview" },
...
export const CLI_TOOLS = {
  ...
  grok: {
    ...
    color: "#1DA1F2",
    description: "xAI Grok Build — open-source terminal coding CLI",
    configType: "guide",
    guideSteps: [
      { step: 1, title: "Install Grok Build", desc: "Install via npm or cargo (see grok-build on GitHub)" },
      { step: 2, title: "Set API Key", desc: "Export your ExtremeRouter API key", value: "export XAI_API_KEY={{apiKey}}", copyable: true },
      { step: 3, title: "Set Base URL", desc: "Point Grok Build at ExtremeRouter", value: "export XAI_BASE_URL={{baseUrl}}", copyable: true },
  ...
  zed: {
    ...
    image: "/providers/zed.svg",
    color: "#1348DC",
    description: "Zed Editor with Hosted AI",
    configType: "custom",
    authMethod: "import",
    notes: [
      { type: "info", text: "Import your Zed Editor cloud credentials (user ID + access token) to route Zed Hosted AI through ExtremeRouter." },
    ],
  },
  cline: {
    id: "cline",
