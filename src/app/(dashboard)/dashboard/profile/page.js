...
import { Card, Button, Toggle, Input, PageHeader } from "@/shared/components";
...
export default function ProfilePage() {
  ...
  const handleExportDatabase = async (password) => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = `extremerouter-backup-${stamp}.json`;
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <PageHeader
        title="Settings"
        description="Security, routing, network, and account preferences"
        icon="settings"
      />
        ...
        <Card>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            ...
            <div className="inline-flex p-1 rounded-lg bg-black/5 dark:bg-white/5 w-full sm:w-auto">
              {["light", "dark", "glass", "system"].map((option) => (
                <button
                  key={option}
                  type="button"
                ...
                >
                  <span className="material-symbols-outlined text-[18px]">
                    {option === "light" ? "light_mode" : option === "dark" ? "dark_mode" : option === "glass" ? "blur_on" : "contrast"}
                  </span>
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-border">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-lg bg-bg border border-border gap-2">
              <div>
                ...
                <p className="text-xs sm:text-sm text-text-muted font-mono break-all">~/.extremerouter/db/data.sqlite</p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  placeholder="https://auth.example.com/application/o/extremerouter/"
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input
                  placeholder="extremerouter-dashboard"
