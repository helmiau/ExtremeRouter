...
// PAT (pt-...) connections sign against the alt inference host: PATs are
// exchanged for short-lived job tokens (jt-...) which api2.qoder.sh accepts
// for direct COSY signing (the api3 host rejects them). Port of VansRouter.
...
// PAT → short-lived job token exchange (POST { personal_token }).
