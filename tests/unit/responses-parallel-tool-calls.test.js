...
// chat tool_calls indices. Regression (decodua/9router e74db4d): a positional
// toolCallIndex advanced only on output_item.done merges all-added-then-deltas
// ordering — every arguments delta lands on index 0, the client concatenates N
